package ru.mirea.schukind.d.e.yandexdriver;
...
import ru.mirea.schukind.d.e.yandexdriver.databinding.ActivityMainBinding;

public class MainActivity extends AppCompatActivity implements DrivingSession.DrivingRouteListener {

    private ActivityMainBinding binding;
    private final String MAPKIT_API_KEY = "e8fde506-f137-409d-ad2f-7b6f13ee9d28";
    private final Point ROUTE_START_LOCATION = new Point(55.803788, 37.402695);
    private final Point ROUTE_END_LOCATION = new Point(55.831388, 37.629277);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PlacemarkMapObject marker = mapView.getMap().getMapObjects().addPlacemark(new
                Point(55.831388, 37.629277), ImageProvider.fromResource(this, R.drawable.gps1));
